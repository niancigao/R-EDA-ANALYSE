---
title: UNIT11A：邏輯式回歸 Logistic Regression
author: 中山大學管理學院 卓雍然
date: "`r Sys.time()`"
output: 
  html_document:
...
```{r}
b = coef(glm1); b   # extract (提取) the regression coef
```
...
# b3*x2 + b2*x1 + b1 = x2 + b2/b3 x1 + b1/b3
# 把 X2 當作 Y軸 移項找斜率 & 截距
# b[2]: -2.540212  b[2]: 0.062735 b[3]: 0.109896
...
then mark the contours (輪廓) of proabilities into the scatter plot 
```{r  fig.width=3.6, fig.height=3.6}
par(cex=0.8, mar=c(4,4,1,1))
...
<span style="font-size:24px"> `r "\U1F5FF"` : </span>
What do the blue/cyan lines means? 閾值<br>
